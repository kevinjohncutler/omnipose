...
Further modified by Kevin cutler to support TensorFlow 2.0 (2021-2022)
------------------------------------------------------------
...
ROOT_DIR = os.path.abspath("/home/kcutler/DataDrive/maskrcnn/Mask_RCNN")
...
dm11_root = '/home/kcutler/DataDrive/results'
basedir = '/home/kcutler/DataDrive/results' # where to save outputs
DEFAULT_LOGS_DIR = os.path.join(basedir, "logs")

# Results directory
# Save submission files here
RESULTS_DIR = os.path.join(basedir, "blah/")
...
if __name__ == '__main__':
    ...
    print('Dataset path',dataset_train)
