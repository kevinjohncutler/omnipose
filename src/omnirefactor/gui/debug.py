"""Interactive debugging utilities for Jupyter notebooks."""
...
def explore_object(obj):
    """
    Interactive Jupyter widget for exploring object attributes.

    Creates a dropdown widget that allows navigating through an object's
    attributes interactively in a Jupyter notebook environment.

    Parameters:
        obj: Any Python object to explore
    """
    try:
