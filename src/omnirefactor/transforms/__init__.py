...
def random_rotate_and_resize(X, Y=None, scale_range=1., gamma_range=[.5,4], tyx=None, 
    ...
    return core.random_rotate_and_resize(X, Y=Y, scale_range=scale_range, gamma_range=gamma_range,
...
from .stacks import make_unique, normalize_stack
from .torch import torch_zoom
