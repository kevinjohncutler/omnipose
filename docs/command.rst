...
omnipose –dir ~/images_cyto/test/ –pretrained_model cyto
–chan 2 –chan2 3 –save_png
...
omnipose –dir ~/test_files –use_gpu –pretrained_model
bact_phase_omni –save_flows –save_outlines –save_tif –in_folders 
...
(target_to_paragraph)= {header-2}\ ``Recommendations`` —————————

There are some optional settings you should consider:

::

–dir_above –in_folders –save_tifs –save_flows –save_outlines
–save_ncolor –no_npy 
