...
class UnetModel():
    ...
    def _set_criterion(self):
        if self.unet:
            ...
            if self.torch:
                ...
                self.criterion0 = ivp_loss.IVPLoss(np.sqrt(2)/5,
                                                   n_steps=2,
                                                   device=self.device,
    ...
    def _train_net(self, train_data, train_labels, train_links, test_data=None, test_labels=None,
        ...
        if dataloader: 
            ...
            # sampler = torch.utils.data.sampler.RandomSampler(training_set)
            ...
            # params = {'batch_sampler': sampler, # mutually exlusive with shuffle, batch_size, and drop_last
            #           'collate_fn': training_set.collate_fn,
            #           'worker_init_fn': training_set.worker_init_fn,
